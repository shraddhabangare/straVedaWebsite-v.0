...
import { useCursorStyle } from '@/lib/utils/cursor-context';
...
export default function Navbar({ currentPage, onNavigate }: NavbarProps) {
  ...
  // Reads Lenis's --scroll-y CSS var via GSAP ticker so it runs in the same
  // unified RAF as Lenis — no competing scroll event listener.
  useEffect(() => {
    let lastY = 0;
    const tick = () => {
      const y = parseFloat(

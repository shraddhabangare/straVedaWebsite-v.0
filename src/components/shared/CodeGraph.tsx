...
const CATEGORY_LABELS: Record<string, string> = {
  ...
  'app/api':        'API Routes',
  // Components
  'sections/pages': 'Page Components',
  'sections':       'Sections',
  'layout':         'Layout',
  'forms':          'Forms',
  'shared':         'Shared',
...
const CATEGORY_ICONS: Record<string, React.ReactNode> = {
  ...
  'sections/pages': <Layers className="w-3.5 h-3.5" />,
  'sections':       <Layers className="w-3.5 h-3.5" />,
  'layout':         <Boxes className="w-3.5 h-3.5" />,
  'forms':          <FileCode2 className="w-3.5 h-3.5" />,
  'shared':         <Boxes className="w-3.5 h-3.5" />,
  'seo':            <FileCode2 className="w-3.5 h-3.5" />,
  'blog':           <FileCode2 className="w-3.5 h-3.5" />,
  'ui':             <Boxes className="w-3.5 h-3.5" />,
  'features':       <GitBranch className="w-3.5 h-3.5" />,
  'server':         <GitBranch className="w-3.5 h-3.5" />,
  'hooks':          <AlertTriangle className="w-3.5 h-3.5" />,
  'lib':            <FileCode2 className="w-3.5 h-3.5" />,
  'types':          <FileCode2 className="w-3.5 h-3.5" />,
